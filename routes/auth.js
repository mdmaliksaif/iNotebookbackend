...
const JWT_SECRET = 'gangadharhishaktimaanhai'; //hard coded ..should be environment variable
...
// Assuming you have already imported the necessary modules and set up the Express router
